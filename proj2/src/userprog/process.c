...
process_wait (tid_t child_tid) 
{
  ...
  if (thread_alive(child_tid)) {
    timer_sleep(1000);
    /*
    //cur->status = THREAD_BLOCKED;
    list_push_back(&cur->waiting_list, &chi->child_waiting_elem);
    printf("waiting....................\n\n\n");
    sema_down(&cur->process_wait_sema);
    printf("done waiting....................\n\n\n");
    //cur->status = THREAD_RUNNING;
    //list_remove (&chi->child_waiting_elem);
